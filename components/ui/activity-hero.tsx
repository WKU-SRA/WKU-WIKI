export default function ActivityHero({
  ...
  return (
    <div className="flex h-[50vh] justify-center sm:h-[55vh] md:h-[80vh] ">
      <div className="mx-auto mt-20 flex justify-center px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8">
        <div className="text-center ">
          <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 dark:text-slate-200 sm:text-6xl md:text-8xl">
            <span className="block xl:inline">
              <span className="mb-2 block">{arr[0]}</span>
            ...
            <div className="mt-2">
              ...
              <span className="relative mt-3 whitespace-nowrap text-blue-600">
                ...
                <span className="relative">{arr[3]}</span>
              </span>
            </div>
          </h1>
